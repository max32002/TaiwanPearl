...
@font-face {
  ...
  src: url(https://github.com/max32002/TaiwanPearl/raw/master/webfont/TaiwanPearl-Regular.woff2) format("woff2")
  , url(https://github.com/max32002/TaiwanPearl/raw/master/webfont/TaiwanPearl-Regular.woff) format("woff");
}
```
