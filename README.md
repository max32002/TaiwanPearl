...
台灣粉圓體基於[思源黑體](https://github.com/adobe-fonts/source-han-sans)與[jf open 粉圓](https://github.com/justfont/open-huninn-font)，大多的字是思源黑體為主，歐文還有部份的中文使用粉圓的中文字。
...
* 在繁體中文字的「肉」部，小編功力不足，所以處理的不太漂亮，相對之下比使用月略醜。
...
* 由於小編對字體編碼方式完全不清楚，相較於原版的「思源黑體」或「jf open 粉圓」，可能有掉一些符號或不常用的字。
